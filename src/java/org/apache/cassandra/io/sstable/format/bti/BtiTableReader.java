...
import org.apache.cassandra.io.sstable.format.bti.PartitionIndex.IndexPosIterator;
...
public class BtiTableReader extends SSTableReaderWithFilter
{
    ...
    public TrieIndexEntry getExactPosition(DecoratedKey dk,
                                           ...
                                           boolean updateStats)
    {
        if (first.compareTo(dk) > 0 || last.compareTo(dk) < 0)
        {
    ...
    {
        return false; // TODO should we really return false?
    }
