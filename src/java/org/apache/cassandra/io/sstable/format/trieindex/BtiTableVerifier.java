...
public class BtiTableVerifier implements IVerifier
{
    ...
    public BtiTableVerifier(ColumnFamilyStore cfs, SSTableReader sstable, boolean isOffline, Options options)
    {
        this(cfs, sstable, new OutputHandler.LogOutput(), isOffline, options);
    }

    public BtiTableVerifier(ColumnFamilyStore cfs, SSTableReader sstable, OutputHandler outputHandler, boolean isOffline, Options options)
    {
        this.cfs = cfs;
...
//        }
    ...
    {
        IndexSummaryComponent indexSummaryComponent = IndexSummaryComponent.load(sstable.descriptor, sstable.metadata());
        Preconditions.checkState(indexSummaryComponent != null);
        indexSummaryComponent.indexSummary.close();
    }
