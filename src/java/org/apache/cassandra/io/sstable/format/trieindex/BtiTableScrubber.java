...
public class BtiTableScrubber implements IScrubber
{
    ...
    private final IScrubber.Options options;
    ...
    {
        this.sstable = (BtiTableReader) transaction.onlyOne();
        ...
        boolean hasIndexFile = sstable.getComponents().contains(Component.PARTITION_INDEX);
...
// position where the row should start in a data file (right after the partition key)
    ...
    private static class ScrubInfo extends CompactionInfo.Holder
    {
        ...
        public ScrubInfo(RandomAccessReader dataFile, SSTableReader sstable, Lock fileReadLock)
        {
            ...
            scrubCompactionId = TimeUUID.Generator.nextTimeUUID();
        }
