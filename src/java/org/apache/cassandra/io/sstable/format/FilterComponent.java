...
public class FilterComponent
{
     ...
     * If the filter is not needed (FP chance is neglectable), it returns {@link AlwaysPresentFilter}.
     ...
     *
     * @return {@link AlwaysPresentFilter}, loaded filter or {@code null} (which means that the filter should be rebuilt)
     */
