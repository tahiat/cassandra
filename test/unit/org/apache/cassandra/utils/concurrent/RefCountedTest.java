...
public class RefCountedTest
{
    ...
    public void testSSTableReaderLeakIsDetected()
    {
        ...
        Descriptor descriptor = Descriptor.fromFilename("test/data/legacy-sstables/nb/legacy_tables/legacy_nb_simple/nb-1-big-Data.db");
        ...
        try
        {
            ...
            {
                SSTableReader reader = SSTableReader.openNoValidation(descriptor, TableMetadataRef.forOfflineTools(tm));
