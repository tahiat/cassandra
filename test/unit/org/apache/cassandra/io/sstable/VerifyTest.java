...
import org.apache.cassandra.io.sstable.format.big.BigTableVerifier.RangeOwnHelper;
...
public class VerifyTest
{
    ...
    {
        Assume.assumeTrue(SSTableFormat.Type.current().info.allComponents().contains(Component.SUMMARY));
