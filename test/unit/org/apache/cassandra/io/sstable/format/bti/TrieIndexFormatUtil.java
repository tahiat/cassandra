...
public class TrieIndexFormatUtil
{
                                            ...
                                            SSTable.Owner owner)
    {
        ...
        StatsMetadata sstableMetadata = (StatsMetadata) new MetadataCollector(metadata.get().comparator)
                                                        .finalizeMetadata(metadata.get().partitioner.getClass().getCanonicalName(), metadata.get().params.bloomFilterFpChance, UNREPAIRED_SSTABLE, null, false, header, null, null)
                                                        .get(MetadataType.STATS);
        return new BtiTableReader.Builder(desc).setComponents(components)
