...
public class SSTableReaderTest
{
    ...
    public void testOpeningSSTable() throws Exception
    {
        ...
        File summaryFile = desc.getFormat().allComponents().contains(Component.SUMMARY) ? desc.fileFor(Component.SUMMARY) : null;
    ...
    public void testLoadingSummaryUsesCorrectPartitioner() throws Exception
    {
        ...
        for(ColumnFamilyStore indexCfs : store.indexManager.getAllIndexColumnFamilyStores())
        {
            ...
            {
                new IndexSummaryComponent(((IndexSummarySupport<?>) sstable).getIndexSummary(), sstable.first, sstable.last).save(sstable.descriptor, true);
